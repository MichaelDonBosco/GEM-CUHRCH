...
export const PASTOR_PHOTO_URL = PASTOR_REV_NAVARATNAM_PHOTO;

export const CHURCH_THEME = {
  primaryGreen: '#043e32',
  primaryGreenDark: '#02241d',
  accentGold: '#fbbf24',
  accentGoldHover: '#f59e0b',
  tintGreen: 'rgba(4, 62, 50, 0.08)',
  borderGreen: 'rgba(4, 62, 50, 0.2)',
};

export default GEM_CHURCH_LOGO;
